              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <div id="external-events">
                    <div class="external-event bg-success">Entega a doña petra</div>
                    <div class="external-event bg-warning">Entega a doña lupita</div>
                    <div class="external-event bg-info">Entega a don jose</div>
                  </div>
                </div>
                <!-- /.card-body -->
              </div>
